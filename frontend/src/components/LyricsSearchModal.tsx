    ...
    >
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 flex flex-col gap-4 p-5 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between">
          <h2 className="text-sm font-semibold text-zinc-800">Search lyrics on Google</h2>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-[11px] text-zinc-500">Copy and paste into Google to find lyrics.</p>
        ...
        <div className="flex flex-col gap-1.5">
          <p className="text-xs font-medium text-zinc-500 uppercase tracking-wide">2 · Paste lyrics here</p>
          <textarea
            ...
            placeholder={'Paste lyrics found on Google here...'}
            value={pasted}
